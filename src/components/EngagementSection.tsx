...
const EngagementSection = () => {
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1464863979621-258b94be4055?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1964&q=80')] bg-cover bg-center bg-blend-overlay bg-opacity-20 opacity-10"></div>
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div className={cn(
              ...
              <button 
                className="w-full py-3 bg-white text-cifcg-800 font-medium rounded-lg hover:bg-cifcg-50 transition-colors shadow-lg shadow-cifcg-900/30"
            ...
            <div className={cn(
              ...
              <button 
                className="w-full py-3 bg-cifcg-600 text-white font-medium rounded-lg hover:bg-cifcg-700 transition-colors shadow-lg shadow-cifcg-900/30"
